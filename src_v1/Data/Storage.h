...
public:
    ...
    /** Add a new TODO record to the database, marked as no-started.  Returns the id no. it was given */
    int add_todo(const std::string &who, const std::string &thing) noexcept;
